...
long playRound(const string& word, int round, const string& playerName, const string& language) {
    ...
    string currentState = "_____";  // начальное состояние слова
    ...
    while (attempts > 0) {
        ...
        Colors(currentState);  // выводим слово с цветами
        cout << endl;
        ...
        currentState = wordchecker(word, trial);  // обновляем состояние слова
        attempts--;
...
int main() {
    ...
    if (player1Wins > player2Wins) {
        if (language1 == "russian") {
            cout << playerName1 << " выиграл игру со счетом " << player1Wins << ":" << player2Wins << "!" << endl;
        } else {
            cout << playerName1 << " won the game with a score of " << player1Wins << ":" << player2Wins << "!" << endl;
        }
    } else if (player1Wins < player2Wins) {
        if (language2 == "russian") {
            cout << playerName2 << " выиграл игру со счетом " << player2Wins << ":" << player1Wins << "!" << endl;
        } else {
            cout << playerName2 << " won the game with a score of " << player2Wins << ":" << player1Wins << "!" << endl;
        }
    } else {
        if (language1 == "russian") {
            cout << "игра закончилась вничью со счетом " << player1Wins << ":" << player2Wins << "!" << endl;
        } else {
            cout << "the game ended in a draw with a score of " << player1Wins << ":" << player2Wins << "!" << endl;
        }
    }
